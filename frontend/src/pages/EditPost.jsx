  ...
  return (
    <div>
        ...
        <div className="px-6 md:px-[200px] mt-8">
            <h1 className="font-bold md-:text-2xl ">Update a Post</h1>
            <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
                ...
                <butoon className="bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg">Update</butoon>
